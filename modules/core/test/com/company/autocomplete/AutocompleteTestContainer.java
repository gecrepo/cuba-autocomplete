...
public class AutocompleteTestContainer extends TestContainer {

    public AutocompleteTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/autocomplete/app.properties",
    ...
    public static class Common extends AutocompleteTestContainer {

        public static final AutocompleteTestContainer.Common INSTANCE = new AutocompleteTestContainer.Common();
